module "dev_tools_tekton_release" {
  source = "github.com/ogaye-ibm/garage-terraform-modules.git//generic/tools/tekton_release?ref=v2.2.5"
...
module "dev_tools_tekton_resources" {
  source = "github.com/ogaye-ibm/garage-terraform-modules.git//generic/tools/tekton_resources?ref=v2.2.5"
