module "dev_serviceaccount_artifactory" {
  source = "github.com/ogaye-ibm/garage-terraform-modules.git//generic/cluster/serviceaccount?ref=v2.2.0"
...
module "dev_tools_artifactory_release" {
  source = "github.com/ogaye-ibm/garage-terraform-modules.git//generic/tools/artifactory_release?ref=v2.2.2"
